...
public class Main {
  ...
  public static void main(String[] args) throws IllegalAccessException {
    ...
    System.out.println(ReflectionSerializer.toJson(customer));
    ...
    System.out.println(ReflectionSerializer.toXml(customer));
    end = System.nanoTime();
    ...
    System.out.println(CustomerSerializer.toJson(customer));
    ...
    System.out.println(CustomerSerializer.toXml(customer));
    end = System.nanoTime();
